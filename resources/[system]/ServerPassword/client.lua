...
---------------------------------------------------------------------------------------------------------------
RegisterNetEvent("Fax:ServerPassword:Spawn")
AddEventHandler("Fax:ServerPassword:Spawn", function()
    Wait(1000)
...
AddEventHandler("Fax:ServerPassword:ShowPasswordPrompt", function()
    local password = KeyboardInput("discord.gg/fYvMAxh #mot-de-passe (" .. attempts .. " tentative" .. (attempts == 1 and "" or "s") .. " restantes)", "", 30)
    attempts = attempts - 1
...
AddEventHandler('Fax:ServerPassword:PassedPassword', function()
    ...
    TriggerEvent("esx:showAdvancedStreamedNotification", 'SymphoniaLife', 'Information ⚠️', 'Mot de passe ~y~validé', 'CHAR_FLOYD', 'symphonia', 2)
end)
