...
ESX.RegisterServerCallback('ddx_menu:Bill_getBills', function(source, cb)
...
ESX.RegisterServerCallback('ddx_menu:Admin_getUsergroup', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
...
-- Weapon Menu --
RegisterServerEvent('ddx_menu:Weapon_AmmoToPedS')
AddEventHandler('ddx_menu:Weapon_AmmoToPedS', function(plyId, value, quantity)
	TriggerClientEvent('ddx_menu:Weapon_AmmoToPedC', plyId, value, quantity)
end)

-- Admin Menu --
RegisterServerEvent('ddx_menu:Admin_teleS')
AddEventHandler('ddx_menu:Admin_teleS', function(plyId, plyPedCoords)
	local _source = source
	local xPlayer  = ESX.GetPlayerFromId(_source)   
	local grade = getIdentity(source)

	bandata = {}
	bandata.reason = 'SymphoniaLife PRIVATE ANTICHEAT | INJECTION DETECTED FOR BRING' -- drop/ban reason
	bandata.period = '0' -- days, 0 for permanent

    if grade.group == 'mod' or grade.group == 'admin' or grade.group == 'superadmin' then
		TriggerClientEvent('ddx_menu:Admin_teleC', plyId, plyPedCoords)
	else
		TriggerEvent('Anticheat:AutoBan', _source, bandata)
	end
end)

RegisterServerEvent('ddx_menu:Admin_Cash')
AddEventHandler('ddx_menu:Admin_Cash', function(money)
	local _source = source
	local xPlayer  = ESX.GetPlayerFromId(_source)   
	local grade = getIdentity(source)
...
RegisterServerEvent('ddx_menu:Admin_Bank')
AddEventHandler('ddx_menu:Admin_Bank', function(money)
	local _source = source
	local xPlayer  = ESX.GetPlayerFromId(_source)   
	local grade = getIdentity(source)
...
RegisterServerEvent('ddx_menu:Admin_DirtyMoney')
AddEventHandler('ddx_menu:Admin_DirtyMoney', function(money)
	local _source = source
	local xPlayer  = ESX.GetPlayerFromId(_source)   
	local grade = getIdentity(source)

	bandata = {}
	bandata.reason = 'SymphoniaLife PRIVATE ANTICHEAT | INJECTION DETECTED FOR DIRTY GIVE' -- drop/ban reason
	bandata.period = '0' -- days, 0 for permanent
...
-- Grade Menu --
RegisterServerEvent('ddx_menu:Patron_promouvoirplayer')
AddEventHandler('ddx_menu:Patron_promouvoirplayer', function(target)
...
RegisterServerEvent('ddx_menu:Patron_destituerplayer')
AddEventHandler('ddx_menu:Patron_destituerplayer', function(target)
	local sourceXPlayer = ESX.GetPlayerFromId(source)
	local targetXPlayer = ESX.GetPlayerFromId(target)
...
RegisterServerEvent('ddx_menu:Patron_recruterplayer')
AddEventHandler('ddx_menu:Patron_recruterplayer', function(target, job, grade)
	local sourceXPlayer = ESX.GetPlayerFromId(source)
	local targetXPlayer = ESX.GetPlayerFromId(target)
...
RegisterServerEvent('ddx_menu:Patron_virerplayer')
AddEventHandler('ddx_menu:Patron_virerplayer', function(target)
	local sourceXPlayer = ESX.GetPlayerFromId(source)
	local targetXPlayer = ESX.GetPlayerFromId(target)
...
RegisterServerEvent('ddx_menu:Patron_promouvoirplayer2')
AddEventHandler('ddx_menu:Patron_promouvoirplayer2', function(target)
	local sourceXPlayer = ESX.GetPlayerFromId(source)
	local targetXPlayer = ESX.GetPlayerFromId(target)
...
RegisterServerEvent('ddx_menu:Patron_destituerplayer2')
AddEventHandler('ddx_menu:Patron_destituerplayer2', function(target)
	local sourceXPlayer = ESX.GetPlayerFromId(source)
	local targetXPlayer = ESX.GetPlayerFromId(target)
...
RegisterServerEvent('ddx_menu:Patron_recruterplayer2')
AddEventHandler('ddx_menu:Patron_recruterplayer2', function(target, job2, grade2)
	local sourceXPlayer = ESX.GetPlayerFromId(source)
	local targetXPlayer = ESX.GetPlayerFromId(target)
...
RegisterServerEvent('ddx_menu:Patron_virerplayer2')
AddEventHandler('ddx_menu:Patron_virerplayer2', function(target)
	local sourceXPlayer = ESX.GetPlayerFromId(source)
	local targetXPlayer = ESX.GetPlayerFromId(target)
