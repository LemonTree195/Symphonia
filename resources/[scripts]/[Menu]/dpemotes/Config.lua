...
-- NOte this might cause an issue of the image getting stuck on peoples screens
	...
	MenuImage = "https://media.giphy.com/media/cPcm2zNby71YI/200_d.gif",
...
Config.Languages = {
  ...
  ['fr'] = {
        ...
        ['propemotes'] = "Emotes avec des objects",
        ...
        ['infoupdateavtext'] = "dadoux93#1994 for SymphoniaLife",
        ['suggestions'] = "",
        ['suggestionsinfo'] = "'",
        ...
        ['notvalidkey'] = "n'est pas une touche valide.",
        ['keybinds'] = "Touches",
        ['keybindsinfo'] = "Use"
  },
  ['de'] = {
