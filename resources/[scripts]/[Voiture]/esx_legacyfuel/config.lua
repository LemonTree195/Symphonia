...
Config.Strings = {
	ExitVehicle = "Quitter le vehicule pour faire le plein",
	EToRefuel = "Appuyez sur ~g~E ~w~pour faire le plein",
	JerryCanEmpty = "Jerry can est vide",
	FullTank = "La voiture est pleine",
	PurchaseJerryCan = "Appuyez sur ~g~E ~w~pour acheter un JerryCan a ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "Appuyez sur ~g~E ~w~pour arreter le pleins",
	CancelFuelingJerryCan = "Appuyez sur ~g~E ~w~pour arreter le pleins du jerry can",
	NotEnoughCash = "Pas assez d'argent",
	RefillJerryCan = "Appuyez sur ~g~E ~w~ pour remplir le jerrycan pour ~g~$",
	NotEnoughCashJerryCan = "Pas assez d'argent pour recharger le jerrycan",
	JerryCanFull = "Jerry can est pleins",
	TotalCost = "Total",
}

if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Appuyez sur ~g~E ~w~attraper un jerrycan"
