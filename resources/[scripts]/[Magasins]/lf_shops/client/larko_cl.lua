...
function AddShopsMenu(menu)
    ...
    local jum = NativeUI.CreateItem("Jumelles", "")
    gpsmenu.SubMenu:AddItem(jum)
    jum:RightLabel("~g~200$")
    ...
    if item == eau then
        ...
        elseif item == cocacola then
            ...
            Citizen.Wait(1)
            ESX.ShowAdvancedNotification("Apu", "Vous avez acheter une bouteille de ~b~Coca-Cola", "", "CHAR_MULTIPLAYER", 1)
        elseif item == icetea then
            TriggerServerEvent('buyIceTea')
            ESX.ShowNotification('Vous avez payez ~r~30$')
            Citizen.Wait(1)
            ESX.ShowAdvancedNotification("Apu", "Vous avez acheter une bouteille d'~b~iceTea", "", "CHAR_MULTIPLAYER", 1)
    ...
    if item == pain then
        ...
        elseif item == hamburger then
            ...
            ESX.ShowNotification('Vous avez payez ~r~30$')
            Citizen.Wait(1)
            ESX.ShowAdvancedNotification("Apu", "Vous avez acheter un ~b~hamburger", "", "CHAR_MULTIPLAYER", 1)
...
local blips = {
    ...
    {title="Epicerie", colour=4, id=52,x = 373.875, y = 325.896, z = 100.319},
    {title="Epicerie", colour=4, id=52,x = 2557.458, y = 382.282, z = 100.319},
    {title="Epicerie", colour=4, id=52,x = -3038.939, y = 585.954, z = 6.908},
    {title="Epicerie", colour=4, id=52,x = -3241.927, y = 1001.462, z = 11.830},
    {title="Epicerie", colour=4, id=52,x = 547.431, y = 2671.710, z = 41.156},
    {title="Epicerie", colour=4, id=52,x = 1961.464, y = 3740.672, z = 31.343},
    {title="Epicerie", colour=4, id=52,x = 2678.916, y = 3280.671, z = 54.241},
    {title="Epicerie", colour=4, id=52,x = 1729.216, y = 6414.131, z = 34.037},
    {title="Epicerie", colour=4, id=52,x = 1135.808, y = -982.281, z = 45.415},
    {title="Epicerie", colour=4, id=52,x = -1222.915, y = -906.983, z = 11.326},
    {title="Epicerie", colour=4, id=52,x = -1487.553, y = -379.107, z = 39.163},
    {title="Epicerie", colour=4, id=52,x = -2968.243, y = 390.910, z = 14.043},
    {title="Epicerie", colour=4, id=52,x = 1166.024, y = 2708.930, z = 37.157},
    {title="Epicerie", colour=4, id=52,x = 1392.562, y = 3604.648, z = 33.980},
    {title="Epicerie", colour=4, id=52,x = -48.519, y = -1757.514, z = 28.421},
    {title="Epicerie", colour=4, id=52,x = 1163.373, y = -323.801, z = 68.205},
    {title="Epicerie", colour=4, id=52,x = -707.501, y = -914.260, z = 18.215},
    {title="Epicerie", colour=4, id=52,x = -1820.523, y = 792.518, z = 137.118},
    {title="Epicerie", colour=4, id=52,x = 1698.388, y = 4924.404, z = 41.063}
