...
Config.Garages = {
	...
	Garage_Centre = {	
		Pos = {x=-326.5802, y= -1020.3991, z= 30.3950},
	...
	Garage_Mecano = {	
		Pos = {x=-52.06, y=-1849.0371, z=29.3950},
		Size  = {x = 3.0, y = 3.0, z = 1.0},
		Color = {r = 204, g = 204, b = 0},
		Marker = 1,
		SpawnPoint = {
			Pos = {x=-52.06, y= -1849.14, z= 26.28},
			Color = {r = 26, g = 43, b = 243},
			Size = {x = 1.5, y = 3, z = 1.0},
			Heading=314.84,
			Marker = 36	
		...
		DeletePoint = {
			Pos = {x=-59.76, y=-1842.3817, z=26.49},
			Color = {r = 243, g = 26, b = 26},
			Size = {x = 1.5, y = 3, z = 1.0},
			Marker = 36
		},
		MunicipalPoundPoint = {
			Pos = {x=-789.93, y=-1285.557, z=4.0},
			Color = {r=25,g=25,b=112},
			Size  = {x = 3.0, y = 3.0, z = 1.0},
			Marker = 1
		},
		SpawnMunicipalPoundPoint = {
			Pos = {x=-776.942, y=-1288.32, z=4.0},
			Color = {r=0,g=255,b=0},
			Size  = {x = 3.0, y = 3.0, z = 1.0},
			Marker = 1,
			Heading=299.42
