...
function SetPropertyOwned(name, price, rented, owner)
	MySQL.Async.execute('INSERT INTO owned_properties (name, price, rented, owner) VALUES (@name, @price, @rented, @owner)', {
		...
		if xPlayer then
			TriggerClientEvent('ddx_property:setPropertyOwned', xPlayer.source, name, true)
...
function RemoveOwnedProperty(name, owner)
	MySQL.Async.execute('DELETE FROM owned_properties WHERE name = @name AND owner = @owner', {
		...
		if xPlayer then
			TriggerClientEvent('ddx_property:setPropertyOwned', xPlayer.source, name, false)
...
MySQL.ready(function()
	MySQL.Async.fetchAll('SELECT * FROM properties', {}, function(properties)
		...
		TriggerClientEvent('ddx_property:sendProperties', -1, Config.Properties)
	end)
end)

ESX.RegisterServerCallback('ddx_property:getProperties', function(source, cb)
	cb(Config.Properties)
end)

AddEventHandler('ddx_ownedproperty:getOwnedProperties', function(cb)
...
AddEventHandler('ddx_property:setPropertyOwned', function(name, price, rented, owner)
	SetPropertyOwned(name, price, rented, owner)
end)

AddEventHandler('ddx_property:removeOwnedProperty', function(name, owner)
	RemoveOwnedProperty(name, owner)
end)

RegisterServerEvent('ddx_property:rentProperty')
AddEventHandler('ddx_property:rentProperty', function(propertyName)
...
RegisterServerEvent('ddx_property:buyProperty')
AddEventHandler('ddx_property:buyProperty', function(propertyName)
	local xPlayer  = ESX.GetPlayerFromId(source)
	local property = GetProperty(propertyName)
...
RegisterServerEvent('ddx_property:removeOwnedProperty')
AddEventHandler('ddx_property:removeOwnedProperty', function(propertyName)
	local xPlayer = ESX.GetPlayerFromId(source)
	RemoveOwnedProperty(propertyName, xPlayer.identifier)
end)

AddEventHandler('ddx_property:removeOwnedPropertyIdentifier', function(propertyName, identifier)
	RemoveOwnedProperty(propertyName, identifier)
end)

RegisterServerEvent('ddx_property:saveLastProperty')
AddEventHandler('ddx_property:saveLastProperty', function(property)
	local xPlayer = ESX.GetPlayerFromId(source)
...
RegisterServerEvent('ddx_property:deleteLastProperty')
AddEventHandler('ddx_property:deleteLastProperty', function()
	local xPlayer = ESX.GetPlayerFromId(source)
...
RegisterServerEvent('ddx_property:getItem')
AddEventHandler('ddx_property:getItem', function(owner, type, item, count)
	...
	if type == 'item_standard' then
		...
		TriggerEvent('ddx_addoninventory:getInventory', 'property', xPlayerOwner.identifier, function(inventory)
	...
	elseif type == 'item_account' then
		...
		TriggerEvent('ddx_addonaccount:getAccount', 'property_' .. item, xPlayerOwner.identifier, function(account)
	...
	elseif type == 'item_weapon' then
		...
		TriggerEvent('ddx_datastore:getDataStore', 'property', xPlayerOwner.identifier, function(store)
...
RegisterServerEvent('ddx_property:putItem')
AddEventHandler('ddx_property:putItem', function(owner, type, item, count)
	local _source      = source
	local xPlayer      = ESX.GetPlayerFromId(_source)
	local xPlayerOwner = ESX.GetPlayerFromIdentifier(owner)
...
ESX.RegisterServerCallback('ddx_property:getOwnedProperties', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('ddx_property:getLastProperty', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('ddx_property:getPropertyInventory', function(source, cb, owner)
	local xPlayer    = ESX.GetPlayerFromIdentifier(owner)
	local blackMoney = 0
	local items      = {}
	local weapons    = {}

	TriggerEvent('ddx_addonaccount:getAccount', 'property_black_money', xPlayer.identifier, function(account)
		blackMoney = account.money
	end)

	TriggerEvent('ddx_addoninventory:getInventory', 'property', xPlayer.identifier, function(inventory)
		items = inventory.items
	end)

	TriggerEvent('ddx_datastore:getDataStore', 'property', xPlayer.identifier, function(store)
...
ESX.RegisterServerCallback('ddx_property:getPlayerInventory', function(source, cb)
	local xPlayer    = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('ddx_property:getPlayerDressing', function(source, cb)
	local xPlayer  = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('ddx_property:getPlayerOutfit', function(source, cb, num)
	local xPlayer  = ESX.GetPlayerFromId(source)
...
RegisterServerEvent('ddx_property:removeOutfit')
AddEventHandler('ddx_property:removeOutfit', function(label)
	local xPlayer = ESX.GetPlayerFromId(source)
...
RegisterServerEvent('ddx_property:setParking')
AddEventHandler('ddx_property:setParking', function(plate, name, zone, vehicleProps)
  local _source = source
  local xPlayer  = ESX.GetPlayerFromId(_source)
...
function Insert(source, plate, name, zone, vehicleProps)
  ...
  MySQL.Async.execute('INSERT INTO `user_parkings` (identifier, plate, name, zone, vehicle) VALUES (@identifier, @plate, @name, @zone, @vehicle)',
  {
    ...
    TriggerClientEvent('esx:showNotification', xPlayer.source, 'Véhicule rangés')
    UpdateState(plate)
  end)
end
...
ESX.RegisterServerCallback('ddx_property:getVehiclesInGarage', function(source, cb, name)
  local xPlayer  = ESX.GetPlayerFromId(source)
...
RegisterServerEvent('ddx_property:DelParking')
AddEventHandler('ddx_property:DelParking', function(plate)
  local _source = source
  local xPlayer  = ESX.GetPlayerFromId(_source)
