...
function StartTheoryTest()
	...
	TriggerServerEvent('ddx_dmvschool:pay', Config.Prices['dmv'])
end
...
function StopTheoryTest(success)
	...
	if success then
		TriggerServerEvent('ddx_dmvschool:addLicense', 'dmv')
...
function StartDriveTest(type)
	...
	TriggerServerEvent('ddx_dmvschool:pay', Config.Prices[type])
end

function StopDriveTest(success)
	if success then
		TriggerServerEvent('ddx_dmvschool:addLicense', CurrentTestType)
		ESX.ShowNotification(_U('passed_test'))
	else
		ESX.ShowNotification(_U('failed_test'))
	end
...
AddEventHandler('ddx_dmvschool:hasEnteredMarker', function(zone)
...
AddEventHandler('ddx_dmvschool:hasExitedMarker', function(zone)
	CurrentAction = nil
	ESX.UI.Menu.CloseAll()
end)

RegisterNetEvent('ddx_dmvschool:loadLicenses')
AddEventHandler('ddx_dmvschool:loadLicenses', function(licenses)
	Licenses = licenses
end)
...
Citizen.CreateThread(function()
	while true do
		...
		if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
			...
			TriggerEvent('ddx_dmvschool:hasEnteredMarker', currentZone)
		end

		if not isInMarker and HasAlreadyEnteredMarker then
			HasAlreadyEnteredMarker = false
			TriggerEvent('ddx_dmvschool:hasExitedMarker', LastZone)
		end
	end
end)
