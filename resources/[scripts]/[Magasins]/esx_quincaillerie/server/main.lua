...
ESX.RegisterServerCallback('ddx_quincaillerie:requestDBItems', function(source, cb)
...
RegisterServerEvent('ddx_quincaillerie:buyItem')
AddEventHandler('ddx_quincaillerie:buyItem', function(itemName, price)
