...
AddEventHandler('onClientMapStart', function()
	...
	ESX.TriggerServerCallback('ddx_quincaillerie:requestDBItems', function(QuincaillerieItems)
...
function OpenQuincaillerieMenu(zone)
	...
	ESX.UI.Menu.Open(
		...
		function(data, menu)
			TriggerServerEvent('ddx_quincaillerie:buyItem', data.current.value, data.current.price)
		end,
		function(data, menu)
...
AddEventHandler('ddx_quincaillerie:hasEnteredMarker', function(zone)
...
AddEventHandler('ddx_quincaillerie:hasExitedMarker', function(zone)
...
Citizen.CreateThread(function()
	while true do
		...
		if isInMarker and not HasAlreadyEnteredMarker then
			...
			TriggerEvent('ddx_quincaillerie:hasEnteredMarker', currentZone)
		end
		if not isInMarker and HasAlreadyEnteredMarker then
			HasAlreadyEnteredMarker = false
			TriggerEvent('ddx_quincaillerie:hasExitedMarker', LastZone)
		end
	end
end)
