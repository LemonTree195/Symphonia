...
function AddMenuPed(menu)
	...
	male = NativeUI.CreateItem('Creer un homme',"Appuyez sur entré pour modifié votre personnage")
	menu:AddItem(male)
	female = NativeUI.CreateItem('Creer une femme',"Appuyez sur entré pour modifié votre personnage")
	menu:AddItem(female)
	--spawnPeds = NativeUI.CreateItem('Spawn Peds',"Appuyez sur entré pour modifié votre personnage")
	--menu:AddItem(spawnPeds)
	submenuspawnpeds = _menuPool:AddSubMenu(mainMenu, "Spawn Peds", "~b~Appuyez sur entré pour modifié votre personnage", Config.MenuX, Config.MenuY,nil,nil,nil,Config.MenuColor.r,Config.MenuColor.g,Config.MenuColor.b,Config.MenuColor.a)
	local newitem = nil
	local list = {'Freemode models', 'Male models', 'Female models'}
	for i=1,#list do
		if i == 1 then newitem = NativeUI.CreateListItem(list[i], gender, 1, "Appuyez sur entré pour modifié votre personnage")
		else newitem = NativeUI.CreateListItem(list[i], Config.table[i], 1, "Appuyez sur entré pour modifié votre personnage") end
		submenuspawnpeds.SubMenu:AddItem(newitem)
		--submenuspawnpeds.SubMenu.AddItem(female)
	end
	appearancemenu = NativeUI.CreateItem('Change Appearance',"Appuyez sur entré pour modifié votre personnage")
	...
	freemodePedMenu.OnMenuClosed = function(Menu)
		TriggerServerEvent('ddx_skin:save', Character)
...
mainMenu = NativeUI.CreateMenu("Creation du personnage", "~b~Faire mon personnage !", Config.MenuX, Config.MenuY,nil,nil,nil,Config.MenuColor.r,Config.MenuColor.g,Config.MenuColor.b,Config.MenuColor.a)
freemodePedMenu = NativeUI.CreateMenu("Creation du personnage", "~b~Faire mon personnage !", Config.MenuX, Config.MenuY,nil,nil,nil,Config.MenuColor.r,Config.MenuColor.g,Config.MenuColor.b,Config.MenuColor.a)
