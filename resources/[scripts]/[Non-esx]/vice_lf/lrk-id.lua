...
Citizen.CreateThread(function()
  AddTextEntry('FE_THDR_GTAO', '~p~SymphoniaLife ~w~- ~p~ID : ' .. GetPlayerServerId(PlayerId()) .. '~w~ - ~p~discord.gg/fYvMAxh ~u~')
  AddTextEntry('PM_PANE_LEAVE', '~o~Retourner sur la liste des serveurs.')
  AddTextEntry('PM_PANE_QUIT', '~r~Quitter SymphoniaLife')
  AddTextEntry('PM_SCR_MAP', 'Carte de SymphoniaLife')
