...
Citizen.CreateThread(function()
	...
	ESX.TriggerServerCallback('ddx_doorlock:getDoorInfo', function(doorInfo, count)
			...
			if distance < maxDistance then
				...
				if IsControlJustReleased(0, Keys['E']) then
					if isAuthorized then
						...
						TriggerServerEvent('ddx_doorlock:updateState', i, doorID.locked) -- Broadcast new state of the door to everyone
					end
				end
			end
		end
...
RegisterNetEvent('ddx_doorlock:setState')
AddEventHandler('ddx_doorlock:setState', function(doorID, state)
