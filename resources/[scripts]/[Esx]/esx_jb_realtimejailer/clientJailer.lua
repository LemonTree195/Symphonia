...
RegisterNetEvent("ddx_jb_jailer:JailInStation")
AddEventHandler("ddx_jb_jailer:JailInStation", function(Station, JailTime)
...
function jailing(Station, JailTime)
	...
	if DoesEntityExist(PlayerPed) then
		...
		Citizen.CreateThread(function()
			...
			TriggerServerEvent('ddx_jb_jailer:UnJailplayer2')
			local outsidecoords = {}
			...
			TriggerEvent('ddx_society:getPlayerSkin')
		end)
	end
end
...
RegisterNetEvent("ddx_jb_jailer:UnJail")
AddEventHandler("ddx_jb_jailer:UnJail", function()
