...
ESX.RegisterUsableItem('bread', function(source)
	...
	TriggerClientEvent('ddx_status:add', source, 'hunger', 200000)
	TriggerClientEvent('ddx_basicneeds:onEat', source)
...
ESX.RegisterUsableItem('water', function(source)
	...
	TriggerClientEvent('ddx_status:add', source, 'thirst', 200000)
...
ESX.RegisterUsableItem('applepie', function(source)
	...
	TriggerClientEvent('ddx_status:add', source, 'hunger', 450000)
	TriggerClientEvent('ddx_basicneeds:onEat', source)
...
ESX.RegisterUsableItem('banana', function(source)
	...
	TriggerClientEvent('ddx_status:add', source, 'hunger', 20000)
	TriggerClientEvent('ddx_basicneeds:onEat', source)
...
ESX.RegisterUsableItem('beef', function(source)
	...
	TriggerClientEvent('ddx_status:add', source, 'hunger', 600000)
	TriggerClientEvent('ddx_basicneeds:onEat', source)
...
ESX.RegisterUsableItem('pizza', function(source)
	...
	TriggerClientEvent('ddx_status:add', source, 'hunger', 500000)
	TriggerClientEvent('ddx_basicneeds:onEat', source)
...
ESX.RegisterUsableItem('icetea', function(source)
	...
	TriggerClientEvent('ddx_status:add', source, 'thirst', 400000)
	TriggerClientEvent('ddx_basicneeds:onDrink', source)
...
ESX.RegisterUsableItem('bolchips', function(source)
	...
	TriggerClientEvent('ddx_status:add', source, 'hunger', 400000)
	TriggerClientEvent('ddx_basicneeds:onEat', source)
...
ESX.RegisterUsableItem('drpepper', function(source)
	...
	TriggerClientEvent('ddx_status:add', source, 'thirst', 600000)
	TriggerClientEvent('ddx_basicneeds:onDrink', source)
...
ESX.RegisterUsableItem('mixapero', function(source)
	...
	TriggerClientEvent('ddx_status:add', source, 'hunger', 800000)
	TriggerClientEvent('ddx_status:add', source, 'thirst', 100000)
	TriggerClientEvent('ddx_basicneeds:onEat', source)
...
ESX.RegisterUsableItem('saucisson', function(source)
	...
	TriggerClientEvent('ddx_status:add', source, 'hunger', 250000)
	TriggerClientEvent('ddx_basicneeds:onEat', source)
...
local xPlayer = ESX.GetPlayerFromId(source)
	...
	TriggerClientEvent('ddx_status:add', source, 'hunger', 300000)
	TriggerClientEvent('ddx_basicneeds:onEat', source)
...
ESX.RegisterUsableItem('shamburger', function(source)
	...
	TriggerClientEvent('ddx_status:add', source, 'hunger', 100000)
	TriggerClientEvent('ddx_basicneeds:onEat', source)
	TriggerClientEvent('esx:showNotification', source, 'Vous mangez un hamburger simple')
...
ESX.RegisterUsableItem('vhamburger', function(source)
	...
	TriggerClientEvent('ddx_status:add', source, 'hunger', 100000)
	TriggerClientEvent('ddx_basicneeds:onEat', source)
	TriggerClientEvent('esx:showNotification', source, 'Vous mangez un hamburger vegan')
	...
	if args[1] then
		...
		if playerId then
			...
			if GetPlayerName(playerId) then
				print(('ddx_basicneeds: %s healed %s'):format(GetPlayerIdentifier(source, 0), GetPlayerIdentifier(playerId, 0)))
				TriggerClientEvent('ddx_basicneeds:healPlayer', playerId)
		...
		print(('ddx_basicneeds: %s healed self'):format(GetPlayerIdentifier(source, 0)))
		TriggerClientEvent('ddx_basicneeds:healPlayer', source)
	end
