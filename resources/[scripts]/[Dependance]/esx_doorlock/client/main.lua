...
Citizen.CreateThread(function()
	...
	ESX.TriggerServerCallback('ddx_doorlock:getDoorInfo', function(doorInfo)
			...
			if distance < maxDistance then
				...
				if IsControlJustReleased(0, 38) then
					if isAuthorized then
						...
						TriggerServerEvent('ddx_doorlock:updateState', k, doorID.locked) -- Broadcast new state of the door to everyone
					end
				end
			end
		end
