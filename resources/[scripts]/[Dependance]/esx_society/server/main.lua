...
AddEventHandler('ddx_society:registerSociety', function(name, label, account, datastore, inventory, data)
...
AddEventHandler('ddx_society:getSocieties', function(cb)
  cb(RegisteredSocieties)
end)

AddEventHandler('ddx_society:getSociety', function(name, cb)
  cb(GetSociety(name))
end)

RegisterServerEvent('ddx_society:withdrawMoney')
AddEventHandler('ddx_society:withdrawMoney', function(society, amount)

  local xPlayer = ESX.GetPlayerFromId(source)
  local society = GetSociety(society)

  TriggerEvent('ddx_addonaccount:getSharedAccount', society.account, function(account)
...
RegisterServerEvent('ddx_society:depositMoney')
AddEventHandler('ddx_society:depositMoney', function(society, amount)
	...
	local source = source
		...
		if PlayersWashing[source] == true then
			...
			if blackMoney.money < Config.Slice then
				TriggerClientEvent("ddx_society:notify", source, "CHAR_LESTER_DEATHWISH", 1, _U('Notification'), false, _U('Nocash') .. Config.Slice)
			else
				...
				TriggerClientEvent("ddx_society:notify", source, "CHAR_LESTER_DEATHWISH", 1, _U('Notification'), false, _U('cash') .. washedMoney .. _U('cash1'))
			end
		end
	end)
end

RegisterServerEvent('ddx_society:washMoney')
AddEventHandler('ddx_society:washMoney', function(amount)
	local xPlayer 		= ESX.GetPlayerFromId(source)
	...
	if amount > 0 and account.money >= amount then
		...
		TriggerClientEvent("ddx_society:notify", source, "CHAR_LESTER_DEATHWISH", 1, _U('Notification'), false, _U('invalid_amount'))
	end

end)

RegisterServerEvent('ddx_society:putVehicleInGarage')
AddEventHandler('ddx_society:putVehicleInGarage', function(societyName, vehicle)

  local society = GetSociety(societyName)

  TriggerEvent('ddx_datastore:getSharedDataStore', society.datastore, function(store)
...
RegisterServerEvent('ddx_society:removeVehicleFromGarage')
AddEventHandler('ddx_society:removeVehicleFromGarage', function(societyName, vehicle)
...
ESX.RegisterServerCallback('ddx_society:getSocietyMoney', function(source, cb, societyName)
...
ESX.RegisterServerCallback('ddx_society:getEmployees', function(source, cb, society)
...
---SECONDJOB INCLUDED
ESX.RegisterServerCallback('ddx_society:getEmployees2', function(source, cb, society)
...
ESX.RegisterServerCallback('ddx_society:getJob', function(source, cb, society)
...
---SECONDJOB INCLUDED
ESX.RegisterServerCallback('ddx_society:getJob2', function(source, cb, society)
...
ESX.RegisterServerCallback('ddx_society:setJob', function(source, cb, identifier, job, grade, type)
...
---SECONDJOB INCLUDED
ESX.RegisterServerCallback('ddx_society:setJob2', function(source, cb, identifier, job2, grade2, type)
...
ESX.RegisterServerCallback('ddx_society:setJobSalary', function(source, cb, job, grade, salary)
...
---SECONDJOB INCLUDED
ESX.RegisterServerCallback('ddx_society:setJobSalary2', function(source, cb, job2, grade2, salary)
...
ESX.RegisterServerCallback('ddx_society:getOnlinePlayers', function(source, cb)
...
---SECONDJOB INCLUDED
ESX.RegisterServerCallback('ddx_society:getOnlinePlayers2', function(source, cb)
...
ESX.RegisterServerCallback('ddx_society:getVehiclesInGarage', function(source, cb, societyName)
