...
RegisterNetEvent("ddx_society:notify")
AddEventHandler("ddx_society:notify", function(icon, type, sender, title, text)
    Citizen.CreateThread(function()
		Wait(1)
        ...
        if data.current.value == 'withdraw_society_money' then
            ...
            ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'withdraw_society_money_amount_' .. society,
            {
                ...
                if amount == nil then
                    ...
                    menu.close()
                    TriggerServerEvent('ddx_society:withdrawMoney', society, amount)
                end
        ...
        elseif data.current.value == 'deposit_money' then
            ...
            ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'deposit_money_amount_' .. society,
            {
                ...
                if amount == nil then
                    ...
                    menu.close()
                    TriggerServerEvent('ddx_society:depositMoney', society, amount)
                end
        ...
        elseif data.current.value == 'wash_money' then
            ...
            ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'wash_money_amount_' .. society,
            {
               title = _U('wash_money_amount')
                ...
                if amount == nil then
                    -- ESX.ShowNotification(_U('invalid_amount'))
					TriggerEvent("ddx_society:notify", "CHAR_LESTER_DEATHWISH", 1, _U('Notification'), false, _U('invalid_amount'))
						ESX.UI.Menu.CloseAll()
                else
                    menu.close()
                    -- TriggerServerEvent('ddx_society:washMoney', society, amount)
					TriggerServerEvent('ddx_society:washMoney', amount)
                end
...
function OpenEmployeeList(society)
  ...
  ESX.TriggerServerCallback('ddx_society:getEmployees', function(employees)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.value == 'fire' then
          ...
          ESX.TriggerServerCallback('ddx_society:setJob', function()
            OpenEmployeeList(society)
...
function OpenEmployeeList2(society)
  ...
  ESX.TriggerServerCallback('ddx_society:getEmployees2', function(employees)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.value == 'fire' then
          ...
          ESX.TriggerServerCallback('ddx_society:setJob2', function()
            OpenEmployeeList2(society)
...
function OpenRecruitMenu2(society)
  ...
  ESX.TriggerServerCallback('ddx_society:getOnlinePlayers2', function(players)
...
function OpenPromoteMenu(society, employee)
  ...
  ESX.TriggerServerCallback('ddx_society:getJob', function(job)
...
function OpenPromoteMenu2(society, employee)
  ...
  ESX.TriggerServerCallback('ddx_society:getJob2', function(job2)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            elseif amount >= Config.MaxSalary then
              ...
              ESX.TriggerServerCallback('ddx_society:setJobSalary', function()
                OpenManageGradesMenu(society)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            elseif amount >= Config.MaxSalary then
              ...
              ESX.TriggerServerCallback('ddx_society:setJobSalary2', function()
                OpenManageGradesMenu(society)
              end, society, data.current.value, amount)
            end
...
AddEventHandler('ddx_society:openBossMenu', function(society, close, options)
