...
AddEventHandler('ddx_addonneeds:resetStatus', function()
	TriggerEvent('ddx_status:set', 'force', 50000) 
...
AddEventHandler('playerSpawned', function()
	...
	if IsDead then
		TriggerEvent('ddx_addonneeds:resetStatus')
	end
...
AddEventHandler('ddx_status:loaded', function(status)
   ...
   TriggerEvent('ddx_status:registerStatus', 'force', 0, ' 	#D500FF', ----- jaune 
	 	function(status)
			return true
		end,
		function(status)
   ...
   Citizen.CreateThread(function()
	    while true do
	        Wait(1000)
	        TriggerEvent('ddx_status:getStatus', 'force', function(status)
