...
Config.Shopkeeper = 228715206 -- hash of the shopkeeper ped
...
Config.Shops = {
    ...
    {coords = vector3(24.03, -1345.63, 29.5-0.98), heading = 266.0, money = {2000, 4000}, cops = 2, blip = true, name = 'Braquage Superette', cooldown = {hour = 3, minute = 30, second = 0}, robbed = false},
    {coords = vector3(-705.73, -914.91, 19.22-0.98), heading = 91.0, money = {2000, 4000}, cops = 2, blip = true, name = 'Braquage Superette', cooldown = {hour = 3, minute = 30, second = 0}, robbed = false}
