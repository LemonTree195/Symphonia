...
function updateStatus(status){
    ...
    var boxHp = status[0].percent;
    var boxTp = status[1].percent;
        if (boxHp <= 15){
            $('#boxHunger').css('background', ' linear-gradient(90deg, rgba(228,42,141,1) 10%, rgba(94,50,199,1) 90%)');
        }  else if (boxHp <= 45){
        $('#boxHunger').css('background', ' linear-gradient(90deg, rgba(228,42,141,1) 10%, rgba(94,50,199,1) 90%)');
    ...
    if (boxTp <= 15){
        $('#boxThirst').css('background', ' linear-gradient(90deg, rgba(228,42,141,1) 10%, rgba(94,50,199,1) 90%)');
    }  else if (boxTp <= 45){
    $('#boxThirst').css('background', ' linear-gradient(90deg, rgba(228,42,141,1) 10%, rgba(94,50,199,1) 90%)');
    }else if (boxTp >= 46){
    $('#boxThirst').css('background', ' linear-gradient(90deg, rgba(228,42,141,1) 10%, rgba(94,50,199,1) 90%)');
