...
Config.PoliceStations = {
	...
	LSPD = {
		...
		Armories = {
			vector3(479.23, -985.45, 24.91)
		},

		Vehicles = {
			{
				Spawner = vector3(454.6, -1017.4, 28.4),
				InsideShop = vector3(447.84, -1018.22, 28.57),
				SpawnPoints = {
...

			{
				...
				InsideShop = vector3(447.84, -1018.22, 28.50),
				SpawnPoints = {
...
Config.AuthorizedVehicles = {
	Shared = {
		...
		{ model = 'police6', label = 'Police Ford', price = 1 },
		--{ model = 'pbus', label = 'Police Prison Bus', price = 0 }
	},

	recruit = {
		{ model = 'police2', label = 'Police Cruiser', price = 1 },
		{ model = 'police6', label = 'Police Ford', price = 1 },
		--{ model = 'pbus', label = 'Police Prison Bus', price = 0 }
	},
	...
	officer = {
		...
		{ model = 'polgt500', label = 'Police Mustang', price = 1 },
		{ model = 'police6', label = 'Police Ford', price = 1 },
