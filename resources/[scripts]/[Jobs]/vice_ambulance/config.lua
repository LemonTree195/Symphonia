...
Config.Hospitals = {
	...
	CentralLosSantos = {
		...
		AmbulanceActions = {
			vector3(339.09, -581.83, 28.94)
		},

		Pharmacies = {
			vector3(337.48, -586.35, 28.94)
		},

		Vehicles = {
			{
				Spawner = vector3(341.88, -560.13, 28.75),
				InsideShop = vector3(343.12, -547.76, 28.74),
				Marker = { type = 36, x = 1.0, y = 1.0, z = 1.0, r = 100, g = 50, b = 200, a = 100, rotate = true },
				SpawnPoints = {
					{ coords = vector3(343.12, -547.76, 28.74), heading = 283.0, radius = 4.0 }
				}
			}
		},
