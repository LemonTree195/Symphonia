...
function OpenAmbulanceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'ambulance_actions', {
		...
		elseif data.current.value == 'boss_actions' then
			TriggerEvent('ddx_society:openBossMenu', 'ambulance', function(data, menu)
				menu.close()
			end, {wash = false})
		end
...
function OpenMobileAmbulanceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'mobile_ambulance_actions', {
		...
		elements = {
			...
			{ label = ('Donne une facture'),   value = 'billing' },
			{label = 'EMS Disponible',     value = 'ems_ouvert'},
			{label = 'EMS non Disponible',     value = 'ems_ferme'}
		}
	}, function(data, menu)
		if data.current.value == 'billing' then

			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'billing', {
				title = ('Rentrer le montant de la facture EMS')
			}, function(data, menu)
				...
				if amount == nil then
					...
					if closestPlayer == -1 or closestDistance > 3.0 then
						...
						TriggerServerEvent('ddx_billing:sendBill24', GetPlayerServerId(closestPlayer), 'society_ambulance', 'Ambulance', amount)
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'citizen_interaction', {
				...
				if closestPlayer == -1 or closestDistance > 1.0 then
					...
					if data.current.value == 'revive' then
						...
						ESX.TriggerServerCallback('ddx_ambulancejob:getItemAmount', function(quantity)
							if quantity > 0 then
								...
								if IsPedDeadOrDying(closestPlayerPed, 1) then
									...
									TriggerServerEvent('ddx_ambulancejob:removeItem', 'medikit')
									TriggerServerEvent('ddx_ambulancejob:revive', GetPlayerServerId(closestPlayer))
						...
						ESX.TriggerServerCallback('ddx_ambulancejob:getItemAmount', function(quantity)
							if quantity > 0 then
								...
								if health > 0 then
									...
									TriggerServerEvent('ddx_ambulancejob:removeItem', 'bandage')
									TriggerServerEvent('ddx_ambulancejob:heal', GetPlayerServerId(closestPlayer), 'small')
						...
						ESX.TriggerServerCallback('ddx_ambulancejob:getItemAmount', function(quantity)
							if quantity > 0 then
								...
								if health > 0 then
									...
									TriggerServerEvent('ddx_ambulancejob:removeItem', 'medikit')
									TriggerServerEvent('ddx_ambulancejob:heal', GetPlayerServerId(closestPlayer), 'big')
									ESX.ShowNotification(_U('heal_complete', GetPlayerName(closestPlayer)))
									IsBusy = false
								else
									ESX.ShowNotification(_U('player_not_conscious'))
					...
					elseif data.current.value == 'put_in_vehicle' then
						TriggerServerEvent('ddx_ambulancejob:putInVehicle', GetPlayerServerId(closestPlayer))
					end
				end
			end, function(data, menu)
				menu.close()
...
--
		...
		if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastHospital ~= currentHospital or LastPart ~= currentPart or LastPartNum ~= currentPartNum)) then
			...
			then
				TriggerEvent('ddx_ambulancejob:hasExitedMarker', LastHospital, LastPart, LastPartNum)
				hasExited = true
			end

			HasAlreadyEnteredMarker, LastHospital, LastPart, LastPartNum = true, currentHospital, currentPart, currentPartNum

			TriggerEvent('ddx_ambulancejob:hasEnteredMarker', currentHospital, currentPart, currentPartNum)
...
AddEventHandler('ddx_ambulancejob:hasEnteredMarker', function(hospital, part, partNum)
...
AddEventHandler('ddx_ambulancejob:hasExitedMarker', function(hospital, part, partNum)
...
RegisterNetEvent('ddx_ambulancejob:putInVehicle')
AddEventHandler('ddx_ambulancejob:putInVehicle', function()
	local playerPed = PlayerPedId()
						...
						if data2.current.stored then
							...
							if foundSpawn then
								...
								ESX.Game.SpawnVehicle(data2.current.model, spawnPoint.coords, spawnPoint.heading, function(vehicle)
									...
									SetVehicleEnginePowerMultiplier(vehicle, 2.0 * 9.0)
...
function StoreNearbyVehicle(playerCoords)
	...
	ESX.TriggerServerCallback('ddx_ambulancejob:storeNearbyVehicle', function(storeSuccess, foundNum)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop', {
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop_confirm', {
			...
			if data2.current.value == 'yes' then
				...
				ESX.TriggerServerCallback('ddx_ambulancejob:buyJobVehicle', function (bought)
					if bought then
...
function OpenPharmacyMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'pharmacy', {
		...
		TriggerServerEvent('ddx_ambulancejob:giveItem', data.current.value)
	end, function(data, menu)
		menu.close()
	end)
end
...
RegisterNetEvent('ddx_ambulancejob:heal')
AddEventHandler('ddx_ambulancejob:heal', function(healType, quiet)
	local playerPed = PlayerPedId()
