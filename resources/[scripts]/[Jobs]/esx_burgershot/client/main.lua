...
function OpenCloakroomMenu()
  ...
  local elements = {
    { label = "Vetements de civil",     value = 'citizen_wear'},
    { label = "Vetements de travail",    value = 'barman_outfit'}
  }
...
function OpenVaultMenu()
    ...
    local elements = {
      {label = "Laitue (x1) - 8$", value = 'lettuce'},
      {label = "Tomate (x1) - 8$", value = 'tomato'},
      {label = "Fromage (x1) - 20$", value = 'cheese'},
      {label = "Patate (x1) - 2$", value = 'potato'},
      {label = "Hamburger congelé (x1) - 5$", value = 'fburger'},
      {label = "Burger végétarien surgelé (x1) - 4$", value = 'fvburger'},
      {label = "Pain (x1) - 3$", value = 'bread'},
      {label = "Pépite (x1) - 1.5$", value = 'nugget'},
      {label = "CocaCola (x1) - 3$", value = 'cocacola'},
      {label = "Eau (x1) - 2$", value = 'water'},
      {label = "Pain végétarien (x1)- 3$", value = 'vbread'}
    }
    ...
    if data.current.value == "cocacola" then
		...
		TriggerServerEvent('ddx_burgershotjob:shop', data.current.value, valor)
      end,
      ...
      function(data, menu)
        ...
        CurrentActionMsg  = "~g~E~w~ pour acheter des ingrédients"
        CurrentActionData = {}
      end
    )
...
function OpenFridgeMenu()
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        CurrentActionMsg  = "~g~E~w~ Pour ouvrir le frigo"
        CurrentActionData = {}
      end
    )
...
function OpenCozinharMenu()
	...
	local elements = {
      {label = "Tomate coupée", value = 'ctomato'},
      {label = "Laitue coupée", value = 'clettuce'},
      {label = "Fromage coupé", value = 'ccheese'},
      {label = "Burger simple", value = 'shamburger'},
      {label = "Burger complet", value = 'hamburger'},
      {label = "Burger végétarien", value = 'vhamburger'},
      {label = "Nuggets x4", value = 'nuggets4'},
      {label = "Nuggets x10", value = 'nuggets10'},
      {label = "Frites", value = 'chips'}
    }
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        TriggerServerEvent('ddx_burgershotjob:craftingCoktails', data.current.value)
      ...
      function(data, menu)
        ...
        CurrentActionMsg  = "~g~E~w~ Pour cuisiner quelque chose"
        CurrentActionData = {}
      end
    )
    ...
    ESX.TriggerServerCallback('ddx_society:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('ddx_society:removeVehicleFromGarage', 'burgershot', vehicleProps)
  ...
  ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'billing', {
    ...
    if amount == nil or amount < 0 then
      ...
      if closestPlayer == -1 or closestDistance > 3.0 then
        ...
        menu.close()
        TriggerServerEvent('ddx_billing:sendBill', GetPlayerServerId(closestPlayer), 'society_burgershot', _U('burgershot'), amount)
      end
    end
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('ddx_burgershotjob:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('ddx_burgershotjob:getStockItem', itemName, count)
            end
...
ESX.TriggerServerCallback('ddx_burgershotjob:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('ddx_burgershotjob:putStockItems', itemName, count)
            end
...
function OpenGetFridgeStocksMenu()
  ...
  ESX.TriggerServerCallback('ddx_burgershotjob:getFridgeStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('ddx_burgershotjob:getFridgeStockItem', itemName, count)
            end
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('ddx_burgershotjob:putFridgeStockItems', itemName, count)
            end
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('ddx_burgershotjob:getVaultWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('ddx_burgershotjob:removeVaultWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('ddx_burgershotjob:addVaultWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
...
function OpenShopMenu(zone)
    ...
    ESX.UI.Menu.Open(
        ...
        function(data, menu)
            TriggerServerEvent('ddx_burgershotjob:buyItem', data.current.value, data.current.price, data.current.realLabel)
        end,
        function(data, menu)
            menu.close()
        end
...
AddEventHandler('ddx_burgershotjob:hasEnteredMarker', function(zone)
	...
	if zone == 'Cook' then
      CurrentAction     = 'menu_cook'
      CurrentActionMsg  = "~g~E~w~ pour cuisiner"
      CurrentActionData = {}
    end
...
AddEventHandler('ddx_burgershotjob:hasExitedMarker', function(zone)
    ...
    while true do
        ...
        if IsJobTrue() then
            ...
            if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
                ...
                TriggerEvent('ddx_burgershotjob:hasEnteredMarker', currentZone)
            end

            if not isInMarker and HasAlreadyEnteredMarker then
                HasAlreadyEnteredMarker = false
                TriggerEvent('ddx_burgershotjob:hasExitedMarker', LastZone)
            end
      ...
      if IsControlJustReleased(0,  Keys['E']) and IsJobTrue() then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('ddx_society:putVehicleInGarage', 'burgershot', vehicleProps)
            ...
            then
              TriggerServerEvent('ddx_service:disableService', 'burgershot')
            end
        ...
        if CurrentAction == 'menu_boss_actions' and IsGradeBoss() then
          ...
          TriggerEvent('ddx_society:openBossMenu', 'burgershot', function(data, menu)
...
RegisterNetEvent('ddx_burgershot:StartCookAnimation')
AddEventHandler('ddx_burgershot:StartCookAnimation', function()
...
RegisterNetEvent('ddx_burgershot:StopCookAnimation')
AddEventHandler('ddx_burgershot:StopCookAnimation', function()
local ped = GetPlayerPed(-1)
