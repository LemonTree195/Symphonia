...
if Config.MaxInService ~= -1 then
  TriggerEvent('ddx_service:activateService', 'unicorn', Config.MaxInService)
end

TriggerEvent('ddx_phone:registerNumber', 'unicorn', _U('unicorn_customer'), true, true)
TriggerEvent('ddx_society:registerSociety', 'unicorn', 'Unicorn', 'society_unicorn', 'society_unicorn', 'society_unicorn', {type = 'private'})



RegisterServerEvent('ddx_unicornjob:getStockItem')
AddEventHandler('ddx_unicornjob:getStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('ddx_addoninventory:getSharedInventory', 'society_unicorn', function(inventory)
...
ESX.RegisterServerCallback('ddx_unicornjob:getStockItems', function(source, cb)
...
RegisterServerEvent('ddx_unicornjob:putStockItems')
AddEventHandler('ddx_unicornjob:putStockItems', function(itemName, count)
...
RegisterServerEvent('ddx_unicornjob:getFridgeStockItem')
AddEventHandler('ddx_unicornjob:getFridgeStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('ddx_addoninventory:getSharedInventory', 'society_unicorn_fridge', function(inventory)
...
ESX.RegisterServerCallback('ddx_unicornjob:getFridgeStockItems', function(source, cb)
...
RegisterServerEvent('ddx_unicornjob:putFridgeStockItems')
AddEventHandler('ddx_unicornjob:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('ddx_unicornjob:buyItem')
AddEventHandler('ddx_unicornjob:buyItem', function(itemName, price, itemLabel)
    ...
    TriggerEvent('ddx_addonaccount:getSharedAccount', 'society_unicorn', function(account)
...
RegisterServerEvent('ddx_unicornjob:craftingCoktails')
AddEventHandler('ddx_unicornjob:craftingCoktails', function(itemValue)
...
ESX.RegisterServerCallback('ddx_unicornjob:getVaultWeapons', function(source, cb)

  TriggerEvent('ddx_datastore:getSharedDataStore', 'society_unicorn', function(store)
...
ESX.RegisterServerCallback('ddx_unicornjob:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('ddx_unicornjob:removeVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('ddx_unicornjob:getPlayerInventory', function(source, cb)
