...
-------- SHOPS --------
    ...
    Flacons = {
        Pos   = { x = 128.61, y = -1282.49, z = 28.34 },
        Size  = { x = 1.0, y = 1.0, z = 1.0 },
        Color = { r = 238, g = 0, b = 0 },
        Type  = 27,
        Items = {
            { name = 'jager',      label = _U('jager'),   price = 15 },
            { name = 'vodka',      label = _U('vodka'),   price = 15 },
            { name = 'rhum',       label = _U('rhum'),    price = 15 },
            { name = 'whisky',     label = _U('whisky'),  price = 15 },
            { name = 'tequila',    label = _U('tequila'), price = 15 },
            { name = 'martini',    label = _U('martini'), price = 15 }
        },
    },

    NoAlcool = {
        Pos   = { x = 129.33, y = -1283.97, z = 28.3 },
        Size  = { x = 1.0, y = 1.0, z = 1.0 },
        ...
        Items = {
            ...
            { name = 'energy',      label = _U('energy'),   price = 10 },
    ...
    Apero = {
        Pos   = { x = 130.24, y = -1285.28, z = 28.29 },
        Size  = { x = 1.0, y = 1.0, z = 1.0 },
        Color = { r = 142, g = 125, b = 76 },
        Type  = 27,
        Items = {
            { name = 'bolcacahuetes',   label = _U('bolcacahuetes'),    price = 5 },
            { name = 'bolnoixcajou',    label = _U('bolnoixcajou'),     price = 5 },
            { name = 'bolpistache',     label = _U('bolpistache'),      price = 5 },
            { name = 'bolchips',        label = _U('bolchips'),         price = 5 },
            { name = 'saucisson',       label = _U('saucisson'),        price = 5 },
            { name = 'grapperaisin',    label = _U('grapperaisin'),     price = 5 }
        },
    },

    Ice = {
        Pos   = { x = 128.37, y = -1281.26, z = 28.29 },
        Size  = { x = 1.0, y = 1.0, z = 1.0 },
        Color = { r = 255, g = 255, b = 255 },
        Type  = 27,
        Items = {
            { name = 'ice',     label = _U('ice'),      price = 3 },
            { name = 'menthe',  label = _U('menthe'),   price = 3 }
        },
    },
