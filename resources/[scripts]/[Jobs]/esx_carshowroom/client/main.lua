...
----markers
AddEventHandler('ddx_qalle_bilpriser:hasEnteredMarker', function (zone)
...
AddEventHandler('ddx_qalle_bilpriser:hasExitedMarker', function (zone)
...
Citizen.CreateThread(function ()
  while true do
    ...
    if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
      ...
      TriggerEvent('ddx_qalle_bilpriser:hasEnteredMarker', currentZone)
    end

    if not isInMarker and HasAlreadyEnteredMarker then
      HasAlreadyEnteredMarker = false
      TriggerEvent('ddx_qalle_bilpriser:hasExitedMarker', LastZone)
    end
  end
end)
