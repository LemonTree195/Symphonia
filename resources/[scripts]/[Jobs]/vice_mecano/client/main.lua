...
function StopNPCJob(cancel)
	...
	if cancel then
		...
		--TriggerServerEvent('ddx_mechanicjob:onNPCJobCompleted')
	end
end
...
function OpenMechanicActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'mechanic_actions', {
			...
			if Config.EnableSocietyOwnedVehicles then
				...
				ESX.TriggerServerCallback('ddx_society:getVehiclesInGarage', function(vehicles)
					...
					ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_spawner', {
						...
						TriggerServerEvent('ddx_society:removeVehicleFromGarage', 'mechanic', vehicleProps)
		...
		elseif data.current.value == 'boss_actions' then
			TriggerEvent('ddx_society:openBossMenu', 'mechanic', function(data, menu)
				menu.close()
			end)
		end
	end, function(data, menu)
	...
	if Config.EnablePlayerManagement and ESX.PlayerData.job and ESX.PlayerData.job.grade_name ~= 'recrue' then
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'mechanic_harvest', {
			...
			if data.current.value == 'gaz_bottle' then
				TriggerServerEvent('ddx_mechanicjob:startHarvest')
			elseif data.current.value == 'fix_tool' then
				TriggerServerEvent('ddx_mechanicjob:startHarvest2')
			elseif data.current.value == 'caro_tool' then
				TriggerServerEvent('ddx_mechanicjob:startHarvest3')
			end
		end, function(data, menu)
			menu.close()
	...
	if Config.EnablePlayerManagement and ESX.PlayerData.job and ESX.PlayerData.job.grade_name ~= 'recrue' then
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'mechanic_craft', {
			...
			if data.current.value == 'blow_pipe' then
				TriggerServerEvent('ddx_mechanicjob:startCraft')
			elseif data.current.value == 'fix_kit' then
				TriggerServerEvent('ddx_mechanicjob:startCraft2')
			elseif data.current.value == 'caro_kit' then
				TriggerServerEvent('ddx_mechanicjob:startCraft3')
			end
		end, function(data, menu)
			menu.close()
...
function OpenMobileMechanicActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'mobile_mechanic_actions', {
		...
		elements = {
			...
			{label = 'Mécano Ouvert',     value = 'mecano_ouvert'},
			{label = 'Mécano Fermé',     value = 'mecano_ferme'},
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'billing', {
				...
				if amount == nil or amount < 0 then
					...
					if closestPlayer == -1 or closestDistance > 3.0 then
						...
						menu.close()
						TriggerServerEvent('ddx_billing:sendBill24', GetPlayerServerId(closestPlayer), 'society_mechanic', _U('mechanic'), amount)
					end
				end
			end, function(data, menu)
				menu.close()
		...
		elseif data.current.value == 'mecano_ouvert' then
			TriggerServerEvent('AnnounceMecanoOuvert')
		elseif data.current.value == 'mecano_ferme' then
					...
					if NPCOnJob then
						if NPCTargetDeleterZone then
							...
							if CurrentlyTowedVehicle == NPCTargetTowable then
								...
								TriggerServerEvent('ddx_mechanicjob:onNPCJobMissionCompleted')
								StopNPCJob()
...
function OpenGetStocksMenu()
	ESX.TriggerServerCallback('ddx_mechanicjob:getStockItems', function(items)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count', {
				...
				if count == nil then
					...
					menu2.close()
					menu.close()
					TriggerServerEvent('ddx_mechanicjob:getStockItem', itemName, count)
...
function OpenPutStocksMenu()
	ESX.TriggerServerCallback('ddx_mechanicjob:getPlayerInventory', function(inventory)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_put_item_count', {
				...
				if count == nil then
					...
					menu2.close()
					menu.close()
					TriggerServerEvent('ddx_mechanicjob:putStockItems', itemName, count)
...
RegisterNetEvent('ddx_mechanicjob:onHijack')
AddEventHandler('ddx_mechanicjob:onHijack', function()
	local playerPed = PlayerPedId()
	local coords    = GetEntityCoords(playerPed)
...
RegisterNetEvent('ddx_mechanicjob:onCarokit')
AddEventHandler('ddx_mechanicjob:onCarokit', function()
	local playerPed = PlayerPedId()
	local coords    = GetEntityCoords(playerPed)
...
RegisterNetEvent('ddx_mechanicjob:onFixkit')
AddEventHandler('ddx_mechanicjob:onFixkit', function()
	local playerPed = PlayerPedId()
	local coords    = GetEntityCoords(playerPed)
...
AddEventHandler('ddx_mechanicjob:hasEnteredMarker', function(zone)
...
AddEventHandler('ddx_mechanicjob:hasExitedMarker', function(zone)
	if zone =='VehicleDelivery' then
		NPCTargetDeleterZone = false
	elseif zone == 'Craft' then
		TriggerServerEvent('ddx_mechanicjob:stopCraft')
		TriggerServerEvent('ddx_mechanicjob:stopCraft2')
		TriggerServerEvent('ddx_mechanicjob:stopCraft3')
	elseif zone == 'Garage' then
		TriggerServerEvent('ddx_mechanicjob:stopHarvest')
		TriggerServerEvent('ddx_mechanicjob:stopHarvest2')
		TriggerServerEvent('ddx_mechanicjob:stopHarvest3')
	end
...
AddEventHandler('ddx_mechanicjob:hasEnteredEntityZone', function(entity)
	local playerPed = PlayerPedId()
...
AddEventHandler('ddx_mechanicjob:hasExitedEntityZone', function(entity)
	...
	while true do
		...
		if ESX.PlayerData.job and ESX.PlayerData.job.name == 'mechanic' then
			...
			if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
				...
				TriggerEvent('ddx_mechanicjob:hasEnteredMarker', currentZone)
			end

			if not isInMarker and HasAlreadyEnteredMarker then
				HasAlreadyEnteredMarker = false
				TriggerEvent('ddx_mechanicjob:hasExitedMarker', LastZone)
			end
	...
	while true do
		...
		if closestDistance ~= -1 and closestDistance <= 3.0 then
			if LastEntity ~= closestEntity then
				TriggerEvent('ddx_mechanicjob:hasEnteredEntityZone', closestEntity)
				LastEntity = closestEntity
			end
		else
			if LastEntity then
				TriggerEvent('ddx_mechanicjob:hasExitedEntityZone', LastEntity)
				LastEntity = nil
			end
		end
	end
			...
			if IsControlJustReleased(0, 38) and ESX.PlayerData.job and ESX.PlayerData.job.name == 'mechanic' then
				...
				elseif CurrentAction == 'delete_vehicle' then
					...
					if Config.EnableSocietyOwnedVehicles then
						...
						TriggerServerEvent('ddx_society:putVehicleInGarage', 'mechanic', vehicleProps)
						...
						then
							TriggerServerEvent('ddx_service:disableService', 'mechanic')
						end
