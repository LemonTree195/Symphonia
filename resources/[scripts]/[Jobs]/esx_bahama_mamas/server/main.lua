...
if Config.MaxInService ~= -1 then
  TriggerEvent('ddx_service:activateService', 'bahama_mamas', Config.MaxInService)
end

TriggerEvent('ddx_phone:registerNumber', 'bahama_mamas', _U('bahama_mamas_customer'), true, true)
TriggerEvent('ddx_society:registerSociety', 'bahama_mamas', 'Bahama_mamas', 'society_bahama_mamas', 'society_bahama_mamas', 'society_bahama_mamas', {type = 'private'})



RegisterServerEvent('ddx_bahama_mamas:getStockItem')
AddEventHandler('ddx_bahama_mamas:getStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('ddx_addoninventory:getSharedInventory', 'society_bahama_mamas', function(inventory)
...
ESX.RegisterServerCallback('ddx_bahama_mamas:getStockItems', function(source, cb)
...
RegisterServerEvent('ddx_bahama_mamas:putStockItems')
AddEventHandler('ddx_bahama_mamas:putStockItems', function(itemName, count)
...
RegisterServerEvent('ddx_bahama_mamas:getFridgeStockItem')
AddEventHandler('ddx_bahama_mamas:getFridgeStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('ddx_addoninventory:getSharedInventory', 'society_bahama_mamas_fridge', function(inventory)
...
ESX.RegisterServerCallback('ddx_bahama_mamas:getFridgeStockItems', function(source, cb)
...
RegisterServerEvent('ddx_bahama_mamas:putFridgeStockItems')
AddEventHandler('ddx_bahama_mamas:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('ddx_bahama_mamas:buyItem')
AddEventHandler('ddx_bahama_mamas:buyItem', function(itemName, price, itemLabel)
    ...
    TriggerEvent('ddx_addonaccount:getSharedAccount', 'society_bahama_mamas', function(account)
...
RegisterServerEvent('ddx_bahama_mamas:craftingCoktails')
AddEventHandler('ddx_bahama_mamas:craftingCoktails', function(itemValue)
...
ESX.RegisterServerCallback('ddx_bahama_mamas:getVaultWeapons', function(source, cb)

  TriggerEvent('ddx_datastore:getSharedDataStore', 'society_bahama_mamas', function(store)
...
ESX.RegisterServerCallback('ddx_bahama_mamas:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('ddx_bahama_mamas:removeVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('ddx_bahama_mamas:getPlayerInventory', function(source, cb)
