...
GodModKickMessage = "SymphoniaLife ANTI-CHEAT | CHEAT DETECTÉ ! VOUS AVEZ ÉTÉ EXCLU DU SERVEUR - [Cheat detection #".. platenum .."]."
kickMessage = "SymphoniaLife ANTI-CHEAT | CHEAT DETECTÉ ! VOUS N'AVEZ PAS LE DROIT DE JOUER ICI ! [Mod Menu detection #".. platenum .."]."
kickMessagePolice = "SymphoniaLife ANTI-RP | DETECTION VOLE DE VEHICULE ! Voler des véhicule de service police/ems n'est pas autorisé! Merci de lire le réglement. [Detection #".. platenum .."]."
BanMessageLuaInjection = "SymphoniaLife ANTI-CHEAT | LUA MOD MENU / INJECTION DETECTÉ - VOUS ÊTES GLOBALEMENT BANNI DE CE SERVEUR [Ban ID: #".. platenum .."]."
BanMessageHealthHack = "SymphoniaLife ANTI-CHEAT | CHEAT DETECTÉ - VOUS ÊTES GLOBALEMENT BANNI DE CE SERVEUR [Ban ID: #".. platenum .."]."
KickSessionSolo = "SymphoniaLife ANTI-RP | SESSION SOLO DETECTÉ - Vous avez été kick du serveur, merci de vous reconnecter.\n[Detection #".. platenum .."]."

function SendWebhookMessageStaff(webhook,message)
	webhook = "https://discordapp.com/api/webhooks/674069503482527765/nVv3WyPOvnSS9nIDJ1x_uuceKPbx63SOxmajqp9KWvxcxZ4VMyUA9S3iOwzgdclMGJtH"
...
AddEventHandler('AC:injectionDetected', function(name, source, isServerEvent)
	...
	TriggerClientEvent('chatMessage', -1, "SymphoniaLife- AntiCheat", {255, 0, 0}, "Le joueur: " .. nom .. " à été banni: "..BanMessageLuaInjection.."")
...
AddEventHandler('AC:ArmeDetect', function(source)
	...
	bandata.period = '0' -- days, 0 for permanent
	TriggerEvent('AntiCheat:AutoBan', source, bandata)
	TriggerClientEvent('chatMessage', -1, "SymphoniaLife- AC", {255, 0, 0}, "Le joueur: " .. nom .. " à été banni: "..BanMessageHealthHack.."")
...
AddEventHandler('AC:CheatDetected2', function(source)
	...
	bandata.period = '0' -- days, 0 for permanent
	TriggerEvent('AntiCheat:AutoBan', source, bandata)
	TriggerClientEvent('chatMessage', -1, "SymphoniaLife- AC", {255, 0, 0}, "Le joueur: " .. name .. " à été banni: "..BanMessageHealthHack.."")
...
AddEventHandler('antilynx8:anticheat', function(meme, memename)
	...
	bandata.period = '0' -- days, 0 for permanent
	TriggerEvent('AntiCheat:AutoBan', source, bandata)
	TriggerClientEvent('chatMessage', -1, "SymphoniaLife- AC", {255, 0, 0}, "Le joueur: " .. memename .. " a été banni: "..BanMessageLuaInjection.."")
end) 