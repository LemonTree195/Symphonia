...
Citizen.CreateThread(function()
	...
	while true do
		...
		ClearFocus()
		ClearHdArea()
		print("^1SymphoniaLife ANTI CHEAT\n^3Analyse terminer\n^3Debug props effectué")
		Wait(1*60000)
	end
end)
...
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(0)
                TriggerEvent('esx:showAdvancedStreamedNotification', 'SymphoniaLife', 'Top-serveur', 'Gagnez plus de 2000$ et une chance de gagner un véhicule moddé. !vote sur discord pour voter', 'CHAR_FLOYD', 'symphonia', 8)
