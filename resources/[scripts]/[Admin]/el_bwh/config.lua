...
Config.popassistformat = "Le joueur %s demande de l\'aide\nWrite <span class='text-success'>/a %s</span> pour accepter ou <span class='text-danger'>/r</span> pour refuser" -- popup assist message format
Config.chatassistformat = "Le joueur %s demande de l\'aide\nWrite ^2/a %s^7 pour accepter ou ^1/r^7 pour refuser \n^4Reason^7: %s" -- chat assist message format
